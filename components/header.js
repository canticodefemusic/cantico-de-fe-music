...
export function renderHeader(settings){
  const items=[["Inicio","/"],["Himnos","/?page=hymns"],["Letras","/?page=lyrics"],["Playlists","/?page=playlists"],["Álbumes","/?page=albums"],["Videos","/?page=videos"],["Devocionales","/?page=devotionals"],["Player","/?page=player"],["Admin","/?page=admin"]];
