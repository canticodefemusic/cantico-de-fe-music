...
export function renderHeader(settings){
  const items=[["Inicio","/"],["Himnos","/?page=hymns"],["Playlists","/?page=playlists"],["Álbumes","/?page=albums"],["Videos","/?page=videos"],["Devocionales","/?page=devotionals"],["Módulos","/?page=modules"],["Admin","/?page=admin"]];
